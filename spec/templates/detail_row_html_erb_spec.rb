...
describe "detail row of test report" do
  ...
  it "should work with one processor" do
    ...
    expect_set_processor(subresult, "The Processor", :happy, "fake elements")
  ...
  it "should work with many processors with all success" do
    ...
    expect_set_processor(subresults[0], "Processor 0", :happy, "fake elements 0")
    expect_set_processor(subresults[1], "Processor 1", :happy, "fake elements 1")
    expect_set_processor(subresults[2], "Processor 2", :sad, "fake elements 2")
  ...
  def expect_set_processor(subresult, description, path_kind, rendered_elements)
